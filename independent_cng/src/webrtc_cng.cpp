...
void ComfortNoiseDecoder::UpdateSid(const std::vector<uint8_t> &sid) {
...
bool ComfortNoiseDecoder::Generate(std::vector<int16_t> &out_data,
                                   bool new_period) {
...
size_t ComfortNoiseEncoder::Encode(const std::vector<int16_t> &speech,
	bool force_sid,
