...
#include "vad_audio_proc.hpp"

#include <math.h>
#include <stdio.h>

#include "fft4g.hpp"
#include "vad_audio_proc_internal.hpp"
#include "pitch_internal.hpp"
#include "pole_zero_filter.hpp"
extern "C" {
//#include "webrtc/modules/audio_coding/codecs/isac/main/source/codec.hpp"
//#include "webrtc/modules/audio_coding/codecs/isac/main/source/lpc_analysis.hpp"
//#include "webrtc/modules/audio_coding/codecs/isac/main/source/pitch_estimator.hpp"
//#include "webrtc/modules/audio_coding/codecs/isac/main/source/structs.hpp"
}
...
void VadAudioProc::SubframeCorrelation(double* corr,
  ...
  //WebRtcIsac_AutoCorr(corr, windowed_audio, kNumSubframeSamples + kNumPastSignalSamples, kLpcOrder);
}
